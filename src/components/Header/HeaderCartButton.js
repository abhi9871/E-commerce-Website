...
const HeaderCartButton = ({handleShowCart}) => {
  ...
  return (
    <div className="text-center">
      <Button className="flex shadow rounded-5 px-4 py-2 bg-body-tertiary fw-bold align-items-center border-0 cart-button m-2 position-relative" onClick={handleShowCart}>
